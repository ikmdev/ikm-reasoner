...
public class ElkInferenceDummyVisitor<O> implements ElkInference.Visitor<O> {
	...
	@Override
	public O visit(ElkClassInclusionExistentialComposition inference) {
		return defaultVisit(inference);
	}
	...
	@Override
	public O visit(ElkClassInclusionTopObjectHasValue inference) {
		return defaultVisit(inference);
	}
	...
	@Override
	public O visit(final ElkObjectPropertyDomainOfClassInclusion inference) {
		return defaultVisit(inference);
	}
