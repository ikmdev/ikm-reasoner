...
public class ClassInconsistencyOfObjectComplementOfMatch3 extends
		AbstractInferenceMatch<ClassInconsistencyOfObjectComplementOfMatch2> {

	private final IndexedContextRootMatch extendedExtendedOriginMatch_;

	ClassInconsistencyOfObjectComplementOfMatch3(
	...
	public interface Visitor<O> {
		...
		O visit(ClassInconsistencyOfObjectComplementOfMatch3 inferenceMatch3);
	...
	public interface Factory {
		...
		ClassInconsistencyOfObjectComplementOfMatch3 getClassInconsistencyOfObjectComplementOfMatch3(
				ClassInconsistencyOfObjectComplementOfMatch2 parent,
				SubClassInclusionComposedMatch2 firstPremiseMatch);
