...
public class SubClassInclusionDecomposedSecondConjunctMatch1 extends
		AbstractInferenceMatch<SubClassInclusionDecomposedSecondConjunct>
		implements SubClassInclusionDecomposedMatch1Watch {

	private final IndexedContextRootMatch originMatch_;

	SubClassInclusionDecomposedSecondConjunctMatch1(
	...
	public interface Visitor<O> {
		...
		O visit(SubClassInclusionDecomposedSecondConjunctMatch1 inferenceMatch1);
	...
	public interface Factory {
		...
		SubClassInclusionDecomposedSecondConjunctMatch1 getSubClassInclusionDecomposedSecondConjunctMatch1(
				SubClassInclusionDecomposedSecondConjunct parent,
				SubClassInclusionDecomposedMatch1 conclusionMatch);
