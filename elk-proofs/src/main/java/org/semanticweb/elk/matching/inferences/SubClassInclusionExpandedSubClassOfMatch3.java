...
public class SubClassInclusionExpandedSubClassOfMatch3 extends
		AbstractInferenceMatch<SubClassInclusionExpandedSubClassOfMatch2> {

	private final IndexedContextRootMatch extendedOriginMatch_;

	SubClassInclusionExpandedSubClassOfMatch3(
	...
	public interface Visitor<O> {
		...
		O visit(SubClassInclusionExpandedSubClassOfMatch3 inferenceMatch3);
	...
	public interface Factory {
		...
		SubClassInclusionExpandedSubClassOfMatch3 getSubClassInclusionExpandedSubClassOfMatch3(
				SubClassInclusionExpandedSubClassOfMatch2 parent,
				SubClassInclusionComposedMatch2 firstPremiseMatch);
