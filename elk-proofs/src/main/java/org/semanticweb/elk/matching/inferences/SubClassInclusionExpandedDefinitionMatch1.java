...
public class SubClassInclusionExpandedDefinitionMatch1
	...
	SubClassInclusionExpandedDefinitionMatch1(
	...
	public interface Visitor<O> {
		...
		O visit(SubClassInclusionExpandedDefinitionMatch1 inferenceMatch1);
	...
	public interface Factory {
		...
		SubClassInclusionExpandedDefinitionMatch1 getSubClassInclusionExpandedDefinitionMatch1(
				SubClassInclusionExpandedDefinition parent,
				SubClassInclusionDecomposedMatch1 conclusionMatch);
