...
public class SubClassInclusionExpandedFirstEquivalentClassMatch3 extends
		AbstractInferenceMatch<SubClassInclusionExpandedFirstEquivalentClassMatch2> {

	private final IndexedContextRootMatch extendedOriginMatch_;

	SubClassInclusionExpandedFirstEquivalentClassMatch3(
	...
	public interface Visitor<O> {
		...
		O visit(SubClassInclusionExpandedFirstEquivalentClassMatch3 inferenceMatch3);
	...
	public interface Factory {
		...
		SubClassInclusionExpandedFirstEquivalentClassMatch3 getSubClassInclusionExpandedFirstEquivalentClassMatch3(
				SubClassInclusionExpandedFirstEquivalentClassMatch2 parent,
				SubClassInclusionComposedMatch2 firstPremiseMatch);
