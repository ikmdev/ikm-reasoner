...
public class SubClassInclusionDecomposedSingletonObjectUnionOfMatch1
	...
	public SubClassInclusionDecomposedMatch2 getConclusionMatch(
			ConclusionMatchExpressionFactory factory) {
		return factory.getSubClassInclusionDecomposedMatch2(getParent(),
				getExtendedDestinationMatch(), disjunctMatch_);
	}
	...
	public interface Visitor<O> {
		...
		O visit(SubClassInclusionDecomposedSingletonObjectUnionOfMatch1 inferenceMatch1);
	...
	public interface Factory {
		...
		SubClassInclusionDecomposedSingletonObjectUnionOfMatch1 getSubClassInclusionDecomposedSingletonObjectUnionOfMatch1(
				SubClassInclusionDecomposedMatch1 parent,
				IndexedContextRootMatch extendedDestinationMatch,
				ElkClassExpression disjunctMatch);
