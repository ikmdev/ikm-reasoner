...
public class SnomedOwlOntologyReasonerInternational20200131TestIT extends SnomedOwlOntologyReasonerTestBase
		implements SnomedVersionInternational {

	@SuppressWarnings("unused")
	private static final Logger LOG = LoggerFactory
			.getLogger(SnomedOwlOntologyReasonerInternational20200131TestIT.class);
	...
	public void loadOntology() throws Exception {
		...
		assertEquals(353211, ontology.getOntology().getAxiomCount());
		assertEquals(352569, ontology.getOntology().getSignature().size());
		assertEquals(352449, ontology.getOntology().getClassesInSignature().size());
