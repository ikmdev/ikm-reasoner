...
public class SnomedOntologyReasonerTest extends // SnomedTestBase {
		SnomedNecessaryNormalFormInternationalTestBase {
	private static final Logger LOG = LoggerFactory.getLogger(SnomedOntologyReasonerTest.class);
